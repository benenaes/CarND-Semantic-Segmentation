...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    """
    stddev_initialized_weights = 0.01
    scale_l2_regularization = 1e-3

    # 1x1 convolutional layer after VGG layer 7 to downsize to num_classes
    kernel_size = 1     # 1 x 1 convolution
    conv_of_layer7 = tf.layers.conv2d(
        vgg_layer7_out,
        num_classes,
        kernel_size,
        padding = 'same',
    ...
    kernel_size = 1
    conv_of_layer4 = tf.layers.conv2d(
        vgg_layer4_out,
        num_classes,
        kernel_size,
        padding='same',
    ...
    # Deconvolutional layer after skip layer 1 : up sample x 2
    kernel_size = 4
    ...
    kernel_size = 1
    conv_of_layer3 = tf.layers.conv2d(
        vgg_layer3_out,
        num_classes,
        kernel_size,
        padding='same',
    ...
    # Deconvolutional layer after skip layer 2 : up sample x 8
    kernel_size = 16
